/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/backend/src/worker-configuration.d.ts` (hash: 7764fae71e88d37cbdfc7afb30cdc568)
// Runtime types generated with workerd@1.20260421.1 2026-04-24 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "SecretObject" | "MetricsObject";
	}
	interface DevelopmentEnv {
		...
		VERSION_PREFIX: "1";
		TEST_STRING: "w4KPFgvgr4";
		SECRETS: DurableObjectNamespace<import("./index").SecretObject>;
		METRICS: DurableObjectNamespace<import("./index").MetricsObject>;
	}
	interface Env {
		ATTACHMENTS: R2Bucket;
		API_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		APP_URL: "http://127.0.0.1:8787" | "https://secred.link";
